...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView home,product,wish,cart,more;

        home = (ImageView) findViewById(R.id.menu_home);
        product = (ImageView) findViewById(R.id.menu_product);
        wish = (ImageView) findViewById(R.id.menu_wish);
        cart = (ImageView) findViewById(R.id.menu_cart);
        more = (ImageView) findViewById(R.id.menu_more);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Toast.makeText(getApplicationContext(), "Hey, You are logged in", Toast.LENGTH_SHORT).show();

        } else if(id == R.id.action_cart){

            Toast.makeText(getApplicationContext(), "Hey, Here is your cart", Toast.LENGTH_SHORT).show();
